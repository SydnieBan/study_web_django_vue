    ...
    <div id="course_unique" class="course_unique">
      <div class="title">
        <div class="title_inner">
          <icon name="course_unique_logo" class="icon" style="border-radius: 50%;width: 50px;height: 50px;margin:35px 0;" ></icon>
          <div style="font-size: 26px;color: white;margin-left: 15px"><strong>精品课程</strong></div>
          <div style="font-size: 20px;color: gray;margin-left: 20px">握住一个最美的梦给未来的自己!</div>
        </div>
      </div>
      ...
      <course-list-box :parameters="parameters" ref="unique_course_list" @get_course_number="on_get_course_number($event)"></course-list-box>
...
<style scoped>
  ...
  .course_unique .title .title_inner{
    width: 1215px;
    height: 130px;
    margin: 0 auto;
    display: flex;
  ...
  .course_unique .title .title_inner .icon:hover{
    cursor: pointer;
  }
